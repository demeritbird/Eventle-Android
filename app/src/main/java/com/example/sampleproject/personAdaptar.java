...
public class personAdaptar extends FirebaseRecyclerAdapter<
        person, personAdaptar.personsViewholder> {

    public personAdaptar(
    ...
    onCreateViewHolder(@NonNull ViewGroup parent,
        ...
        return new personAdaptar.personsViewholder(view);
    }
